...
Survey ladder (numbers TBD from Phase 2): Tier 0 duplicates → Tier 1 + self-binding → Tier 2 predicted split → Tier 3 runtime-confirmed. Report the whole ladder; the gap between "preconditions common" and "full alignment rare" is itself the finding.
